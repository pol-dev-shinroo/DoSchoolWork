...
export default function PdfMergeWorkspace({
  ...
  const i18n = {
    ...
    el: {
      title: "Λίστα Συγχώνευσης",
      docs: "Έγγραφα",
      howItWorks: "Πώς λειτουργεί:",
      infoDesc:
        "Το πάνω αρχείο είναι το Βασικό σας Έγγραφο. Για να εισαγάγετε το δεύτερο αρχείο μέσα σε αυτό, πληκτρολογήστε έναν αριθμό σελίδας. Αφήστε το κενό για προσθήκη στο τέλος.",
      baseDoc: "Βασικό Έγγραφο",
      insertDoc: "Έγγραφο Εισαγωγής",
      pages: "Σελίδες",
      sameName: "Ίδιο Όνομα",
      insertAfter: "Εισαγωγή μετά τη σελίδα:",
      addSecond: "Προσθήκη Δεύτερου Αρχείου",
      mergeBtn: "Συγχώνευση & Λήψη",
      processing: "Συγχώνευση...",
      clearAll: "Εκκαθάριση Όλων",
      exceedsBase: "Υπερβαίνει το μήκος του εγγράφου",
    },
    km: {
      title: "បញ្ជីបញ្ចូលចូលគ្នា",
      docs: "ឯកសារ",
      howItWorks: "របៀបបញ្ចូលចូលគ្នា៖",
      infoDesc:
        "ឯកសារកំពូលគឺជាឯកសារគោលរបស់អ្នក។ ដើម្បីបញ្ចូលឯកសារទីពីរទៅក្នុងវាដោយផ្ទាល់ សូមបញ្ចូលលេខទំព័រ។ ទុកវាឱ្យទទេដើម្បីបញ្ចូលនៅចុងបញ្ចប់។",
      baseDoc: "ឯកសារគោល",
      insertDoc: "ឯកសារបញ្ចូល",
      pages: "ទំព័រ",
      sameName: "ឈ្មោះដូចគ្នា",
      insertAfter: "បញ្ចូលបន្ទាប់ពីទំព័រ៖",
      addSecond: "បន្ថែមឯកសារទីពីរ",
      mergeBtn: "បញ្ចូលចូលគ្នា និងទាញយក",
      processing: "កំពុងបញ្ចូលចូលគ្នា...",
      clearAll: "លុបទាំងអស់",
      exceedsBase: "លើសពីប្រវែងឯកសារគោល",
    },
    id: {
      title: "Daftar Gabungan",
      docs: "Dokumen",
      howItWorks: "Cara kerja penggabungan:",
      infoDesc:
        "File teratas adalah Dokumen Dasar Anda. Untuk menyisipkan file kedua tepat di dalamnya, ketik nomor halaman. Biarkan kosong untuk menambahkannya di akhir.",
      baseDoc: "Dokumen Dasar",
      insertDoc: "Sisipkan Dokumen",
      pages: "Halaman",
      sameName: "Nama Sama",
      insertAfter: "Sisipkan setelah halaman:",
      addSecond: "Tambah File Kedua",
      mergeBtn: "Gabungkan & Unduh",
      processing: "Menggabungkan...",
      clearAll: "Hapus Semua",
      exceedsBase: "Melebihi panjang dokumen dasar",
    },
  };
